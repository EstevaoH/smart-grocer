...
export function RecipeGenerator({ onAddItems }: RecipeGeneratorProps) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            alert("Algo deu errado com a IA. Tente novamente.");
        } finally {
            setIsLoading(false);
        }
    };
                    ...
                    <button
                        ...
                        className={`
                            ...
                            ${isLoading || !input.trim()
                                ...
                                : 'bg-gradient-to-r from-primary to-secondary cursor-pointer text-gray-800 shadow-md hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0'}
                        `}
                    >
                        {isLoading ? (
                            <>
